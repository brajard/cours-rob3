...
\item Pour stocker une chaîne de \Verb|n| éléments, il
...
et afficher "Prenez un parapluie" si l'utilisateur a mis pluie.
\end{exampleblock}
\end{frame}
...
\red{Renvoie 0}  si les les chaînes \bvrb|£textitµs1§| et \bvrb|£textitµs2§|
sont égales.\\
\hline
