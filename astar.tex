...
\item Le coût pour aller d'un noeud à son voisin (ici : 1 pour tous les noeuds).
\end{itemize}
...
\item Les cases à explorer : ces cases sont stockées dans une liste, l'\textcolor{green}{openList}. On a calculé leur valeurs mais on ne les a pas encore explorées.
