...
\subsection{Autres variables "structurées"}
\begin{frame}
  \begin{columns}
    \column{4.8cm}
...
\begin{frame}[fragile]
\frametitle{Les énumérations}
\begin{block}{}
Les énumérations permettent de
définir des constantes.

Elles accroient la lisibilité des programmes.
\end{block}
...
\begin{block}{}
Il est possible de définir un type \bvrb|enum|.
\end{block}
\begin{codeblock}{}
\vspace{-.3cm}
\lstset{escapeinside={§§}}
...
\begin{block}{}
Les unions permettent de définir une variable
qui a un type "variable" parmi plusieurs.
\end{block}
La syntaxe est très proche de celle utilisée pour
les structures :
\begin{codeblock}{}
\vspace{-.3cm}
\lstset{escapeinside={§§}}
...
\begin{alertblock}{}
La taille de la variable est égale à la taille du 
...
\begin{codeblock}{Modèle de structure}
\vspace{-.3cm}
\lstset{escapeinside={§§}}
\lstset{basicstyle=\scriptsize}
\begin{codeC}
